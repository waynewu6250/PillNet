...
class InceptionResnetV1:
    ...
    def reduction_a(self, net, k, l, m, n):
        with tf.variable_scope('Branch_0'):
    ...
    def inference(self, images, keep_probability, phase_train=True, 
    ...
    def inception_resnet_v1(self, inputs, is_training=True,
